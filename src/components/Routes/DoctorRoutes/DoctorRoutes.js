...
import ScheduleTimings from "../../Doctors/scheduleTimings/ScheduleTimings";
export default function DoctorRoutes() {
  ...
  return (
    <DoctorLayout name={breadCrumBar.name} title={breadCrumBar.title} main={breadCrumBar.main}>
      ...
      <Route exact path="/schedule-timing">
        <DoSomethingWrapper
